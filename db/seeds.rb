...
User.create!(name: "Jimmy", email: "jimmy@email.com", phone_number: "3125137536", birth_date: "01/05/1996", height: 70, weight: 1, waist_size: 1, target_weight: 1, target_waist_size: 1, password: "password", password_confirmation: "password")
User.create!(name: "lisa", email: "lisa@email.com", phone_number: "3125137536", birth_date: "01/05/1996", height: 65, weight: 1, waist_size: 1, target_weight: 1, target_waist_size: 1, password: "password", password_confirmation: "password")
User.create!(name: "isaac", email: "isaac@email.com", phone_number: "3125137536", birth_date: "01/05/1996", height: 72, weight: 1, waist_size: 1, target_weight: 1, target_waist_size: 1, password: "password", password_confirmation: "password")
User.create!(name: "kim", email: "kim@email.com", phone_number: "3125137536", birth_date: "01/05/1996", height: 66, weight: 1, waist_size: 1, target_weight: 1, target_waist_size: 1, password: "password", password_confirmation: "password")
User.create!(name: "damon", email: "damon@email.com", phone_number: "3125137536", birth_date: "01/05/1996", height: 74, weight: 1, waist_size: 1, target_weight: 1, target_waist_size: 1, password: "password", password_confirmation: "password")
User.create!(name: "anna", email: "anna@email.com", phone_number: "3125137536", birth_date: "01/05/1996", height: 64, weight: 1, waist_size: 1, target_weight: 1, target_waist_size: 1, password: "password", password_confirmation: "password")
...
Repeat for the desired number of repetitions.", category_id: 1 , routine: "", muscle_group_id: 1) 
...
Slowly lower back to the starting position and repeat for the desired number of repetitions.", category_id: 1, routine: "", muscle_group_id: 1) 
...
Repeat for the desired number of repetitions.", category_id: 1, routine: "", muscle_group_id: 2) 
...
Pull your chin towards the bar until the lats are fully contracted, then slowly lower yourself back to the start position and repeat for the assigned number of repetitions.", category_id: 1, routine: "", muscle_group_id: 2) 
...
Repeat for the desired number of repetitions.", category_id: 1, routine: "", muscle_group_id: 3) 
...
Repeat for desired reps", category_id: 1, routine: "", muscle_group_id: 3) 
...
Do not pause, but go straight into the next rep!", category_id: 1, routine: "", muscle_group_id: 3) 
...
Repeat for the desired number of repetitions.", category_id: 1, routine: "", muscle_group_id: 4) 
...
#legs
Exercise.create!(name: "Leg press", description: "", category_id: 1, routine: "", muscle_group_id: 5) 
Exercise.create!(name: "squat", description: "", category_id: 1, routine: "", muscle_group_id: 5) 
Exercise.create!(name: "leg extension", description: "", category_id: 2, routine: "", muscle_group_id: 5) 

#abs
Exercise.create!(name: "abs 1", description: "", category_id: 3, routine: "", muscle_group_id: 6) 
Exercise.create!(name: "abs 2", description: "", category_id: 3, routine: "", muscle_group_id: 6) 
Exercise.create!(name: "abs 3", description: "", category_id: 3, routine: "", muscle_group_id: 6) 



Plan.create!(user_id: 1, exercise_id: 1, routine: "")
Plan.create!(user_id: 1, exercise_id: 7, routine: "")
Plan.create!(user_id: 2, exercise_id: 1, routine: "")
Plan.create!(user_id: 4, exercise_id: 11, routine: "")

Workout.create!(user_id: 1, exercise_id: 1, max_best: "")
Workout.create!(user_id: 4, exercise_id: 1, max_best: "")
